...
const DarkModeToggle: React.FC<DarkModeToggleProps> = ({ isDarkMode, toggleDarkMode }) => {
  return (
    <motion.button
      ...
      whileTap={{ scale: 0.95 }}
      className="relative w-12 h-7 sm:w-14 sm:h-8 bg-gray-300 dark:bg-gray-600 rounded-full p-1 transition-colors duration-300 min-h-[44px] min-w-[44px] flex items-center justify-center"
      data-cursor-hover
    >
      <motion.div
        animate={{
